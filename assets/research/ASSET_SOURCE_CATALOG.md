...
项目提供方于 2026-09-21 确认 `Black Cloud, Red Fire`、`Smoke Rises High` 与 `Mischievous As Ever` 三首 Game Science 曲目可用于本项目公开发布。生产副本位于 `public/audio/`，逐项许可与用途记录位于 `src/data/media.json`；文件未作内容性修改。
